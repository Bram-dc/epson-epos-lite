export const toHexBinary = (s: string) => {
...
export const toBase64Binary = (s: string) => {
...
export const toMonoImage = (imgdata: { data: number[], width: number, height: number }, s: number, g: number) => {
...
export const toGrayImage = (imgdata: { data: number[], width: number, height: number }, g: number) => {
...
export const escapeControl = (s: string) => {
...
export const getEnumAttr = (name: string, value: string, regex: RegExp) => {
...
export const getBoolAttr = (name: string, value: boolean) => {

    return ' ' + name + '="' + value + '"'

}

export const getIntAttr = (name: string, value: number, min: number, max: number) => {
...
export const getUByteAttr = (name: string, value: number) => {

    return getIntAttr(name, value, 0, 255)

}

export const getUShortAttr = (name: string, value: number) => {

    return getIntAttr(name, value, 0, 65535)

}

export const getShortAttr = (name: string, value: number) => {

    return getIntAttr(name, value, -32768, 32767)

}

export const getEnumIntAttr = (name: string, value: string | number, regex: RegExp, min: number, max: number) => {
